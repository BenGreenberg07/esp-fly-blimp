...
/* TELEMETRY BACK to the host: broadcast the 4 current motor commands so the Mac
 * can log input (motors) paired with output (mocap state) for system ID. Frame =
 * TELEM_MAGIC(4) + 4 LE float32 (fwdL, fwdR, up, down). Throttle at the call site. */
